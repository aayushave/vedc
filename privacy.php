...
<body>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Inspire. Innovate. Inform.</h2>
                <p>The Entrepreneurship Development Cell of VIT Pune aims to produce successful entrepreneurs imbibed with leadership qualities using innovative and ethical business practices to make a global impact.</p>
                <a href="#featured-services" class="btn-get-started scrollto">Get Started</a><a href="#featured-services" class="btn-get-started scrollto">Get Started</a>
              </div>
            </div>
          </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+155895548855">+91 9511893297</a></p>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>V-EDC</strong>. All Rights Reserved
      </div>
      <div class="credits">
